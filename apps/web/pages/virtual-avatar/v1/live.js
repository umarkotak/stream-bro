  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Configure and copy a transparent Creator Buddy avatar overlay URL for OBS." />
      </Head>
        ...
        <div className="overlay-setup-workspace">
          ...
          <aside className="overlay-config-controls">
            ...
            <section className="overlay-url-section">
              <header><span>04</span><div><b>OBS URL</b><small>Keep Creator Buddy running</small></div></header>
