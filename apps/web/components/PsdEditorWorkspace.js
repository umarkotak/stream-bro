  ...
  return (
    <main className="app-main editor-shell">
      <header className="app-page-bar">
        <div><h1>Avatar {version} · PSD Editor</h1><span>Paste, position, and export exact layers</span></div>
      ...
      <div className="editor-command-bar">
        ...
        <label><span>Canvas</span><select value={canvasSize} onChange={onCanvasSizeChange}><option value="512">512 × 512</option><option value="1024">1024 × 1024</option><option value="2048">2048 × 2048</option></select></label>
        ...
        <button className="editor-export" onClick={onExport} disabled={exporting}>{exporting ? "Building…" : "Export PSD ↗"}</button>
      </div>
